  ...
  theme: {
    extend: {
      colors: {
        ...
        /* 用于文件、会议、人员的密级标识 */
        'security-1': {
          DEFAULT: '0 85% 50%',      // #EA1515 一级密级-红色
          light: '0 85% 95%',        // #FEE9E9 背景色
          border: '0 85% 60%',       // #F44336 边框色
          text: '0 85% 35%',         // #B31312 文字色
          hover: '0 85% 45%',        // 悬停态
        },
        'security-2': {
          DEFAULT: '30 95% 55%',     // #FA8C16 二级密级-橙色
          light: '30 95% 95%',       // #FFF7E6 背景色
          border: '30 95% 65%',      // #FFA940 边框色
          text: '30 95% 35%',        // #AD6800 文字色
          hover: '30 95% 50%',       // 悬停态
        },
        'security-3': {
          DEFAULT: '142 76% 36%',    // #52C41A 三级密级-绿色
          light: '142 76% 95%',      // #F6FFED 背景色
          border: '142 76% 46%',     // #73D13D 边框色
          text: '142 76% 26%',       // #389E0D 文字色
          hover: '142 76% 31%',      // 悬停态
        },
        ...
        'participant-internal': {
          DEFAULT: '0 0% 25%',       // #404040 内部人员-深灰
          light: '0 0% 96%',         // #F5F5F5 背景色
          border: '0 0% 35%',        // #595959 边框色
          text: '0 0% 15%',          // #262626 文字色
          hover: '0 0% 30%',         // 悬停态
        },
        'participant-temporary': {
          DEFAULT: '0 0% 65%',       // #A6A6A6 临时人员-浅灰
          light: '0 0% 98%',         // #FAFAFA 背景色
          border: '0 0% 75%',        // #BFBFBF 边框色
          text: '0 0% 52%',          // #848484 文字色
          hover: '0 0% 60%',         // 悬停态
        },
